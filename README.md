...
## Environments
- Preview: https://main--swetabar-usaa--aemysites.aem.page/
- Live: https://main--swetabar-usaa--aemysites.aem.live/
- Block Library: https://main--swetabar-usaa--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `swetabar-usaa` directory in your favorite IDE and start coding :)
